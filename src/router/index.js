...
/* Router Modules */
import MissingEvents from './modules/missing-events'
 ...
 *
 * hidden: true                   if set true, item will not show in the sidebar(default is false) 是否在边栏显示
...
export const constantRoutes = [
  ...
  // },
  {
    ...
    component: Layout,
    redirect: '/missing-events/management/clues/index',
    hidden: true,
    children: [
      {
        path: 'index',
    ...
    children: [
      {
        ...
        name: 'Messages',
        meta: { title: '消息', icon: 'message', noCache: true } // 面包屑导航里显示的
      }
    ]
  },
  {
